...
@NonNullApi
public class AlkaaMainProjectDependency extends DelegatingProjectDependency {

    @Inject
    public AlkaaMainProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
